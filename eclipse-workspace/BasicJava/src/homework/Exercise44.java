...
public class Exercise44 {
	public static void main(String[] args) {
		...
		System.out.print("결과: ");
		if (boy.equals(girl)) { // 비기는 경우
			System.out.println("비겼습니다.");
		} else if (boy.equals("가위")) { // 철수 = 가위
			if (girl.equals("바위")) {
				System.out.println("영희 승리!");
			} else if (girl.equals("보")) {
				System.out.println("철수 승리!");
			}
		} else if (boy.equals("바위")) { // 철수 = 바위
			if (girl.equals("가위")) {
				System.out.println("철수 승리!");
			} else if (girl.equals("보")) {
				System.out.println("영희 승리!");
			}
		} else if (boy.equals("보")) { // 철수 = 보
			if (girl.equals("바위")) {
				System.out.println("철수 승리!");
...
if(boy.equals(girl)) {
	result = "비김";
} else if (boy.equals("가위") && girl.equals("바위")
		   || boy.equals("바위") && girl.equals("보") 
		   || boy.equals("보") && girl.equals("가위")) {
	result = "영희 승리!";
} else {
	result = "철수 승리!";
}
...
/* 두번째 방법
 ...
 if (boy.equals("바위") && girl.equals("가위") ) {
System.out.println("철수 승리!");
...
System.out.println("철수 승리!");
} else if (boy.equals("보") && girl.equals("가위")) {
System.out.println("영희 승리!");
}*/
